...
public class ViewIssuedBooks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book Name", "Author", "Publisher", "ISBN", "Student Name", "Student Id"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            PreparedStatement stmt=con.prepareStatement("select * from issued;");
            ...
            while(rs.next())
            {
                ...
                d=rs.getLong("ISBN");
                e=rs.getString("StudentName");
                f=rs.getInt("StudentId");
                td.addRow(new Object[]{a,b,c,d,e,f});
            }
